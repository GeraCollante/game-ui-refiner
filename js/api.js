 ...
 */
export async function callModel(modelId, messages, apiKey, maxTokens, role) {
 ...
 */
export async function callModelForced(provider, modelId, messages, apiKey, maxTokens, role) {
...
// OpenRouter client
// =====================================================================
async function callOpenRouter(modelId, messages, apiKey, maxTokens) {
...
// =====================================================================
async function callGoogle(modelId, messages, apiKey, maxTokens) {
    const body = openAiToGoogle(messages);
 ...
 */
export function openAiToGoogle(messages) {
...
// Message builders
// =====================================================================
export function buildInitialGenMessages(sysPrompt, targetUrl) {
    return [
...
export function buildRefineMessages(sysPrompt, targetUrl, currentRenderUrl, prevSvelte, prevHtml, critique) {
    const userContent = [
        {
            type: 'text',
...
export function buildFeedbackMessages(sysPrompt, targetUrl, currentRenderUrl, prevSvelte, prevHtml, humanFeedback) {
    const userContent = [
        {
            type: 'text',
            text: 'IMAGEN 1: TARGET original. IMAGEN 2: render actual de tu output previo. ' +
...
export function renderInIframe(html) {

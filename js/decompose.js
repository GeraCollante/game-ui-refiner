 ...
 */
export function compileLayersToCss(d) {
...
function compileLayerInner(layer) {
    if (layer.svg && layer.svg.trim())
        return layer.svg.trim();
    if (layer.text != null)
        return escapeHtml(String(layer.text));
    return '';
}
...
export function compileLayersToMarkup(d, state = 'idle', isolate = null) {
 ...
 */
export function compileLayersToSvelte(d, opts = {}) {
